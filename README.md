...
- run the docker container:
        ...
        docker run -d --net host -v /my_server/q3ut4:/q3ut4 tomdesinto/urbanterror:4.2.019
...
- run the docker container:
        ...
        docker run -d --net host -v /my_server/q3ut4:/q3ut4 -v /my_server/maps:/maps tomdesinto/urbanterror:4.2.019
...
To run the server on port 27000:
    ...
    docker run -d --net host -v /my_server/q3ut4:/q3ut4 -e URT_PORT=27000 tomdesinto/urbanterror:4.2.019
...
You can connect with SSH or SFTP to the docker container with user `root` on port 22 and using [this INSECURE private key](http://bit.ly/1hc36Ii) [PuTTY format](http://bit.ly/NfDhxG) and starting your container as follow:
    ...
    docker run -d --net host -v /my_server/q3ut4:/q3ut4 -v /my_server/maps:/maps tomdesinto/urbanterror:4.2.019 /sbin/my_init --enable-insecure-key
...
This image is based on tomdesinto/urbanterror-data which contains just the Urban Terror files (~2GB be patient).
    ...
    sudo docker build -t tomdesinto/urbanterror:4.2.019 .
